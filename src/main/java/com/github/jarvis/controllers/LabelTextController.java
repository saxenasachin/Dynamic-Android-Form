 ...
 */
public abstract class LabelTextController extends FormElementController {
    ...
    private Set<InputValidator> mobileValidators;
     ...
     */
    public LabelTextController(Context ctx, String name, String labelText, boolean isRequired) {
     ...
     *                      non-null value upon validation. Otherwise, this field can be empty.
     */
    public LabelTextController(Context ctx, String name, String labelText, boolean isRequired, boolean isMobile) {
        this(ctx, name, labelText, new HashSet<InputValidator>());
        setIsRequired(isRequired);
     ...
     */
    public LabelTextController(Context ctx, String name, String labelText, Set<InputValidator> validators) {
        super(ctx, name);
    ...
    protected View createView() {
        ...
        @SuppressLint("InflateParams") View view = inflater != null ? inflater.inflate(R.layout.form_labeled_element, null) : null;
        if (view != null) {
